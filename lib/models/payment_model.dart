class PaymentModel {
  ...
  PaymentModel({
    this.id, this.assignmentId, this.studentName = '',
    required this.amount, required this.paymentDate,
    required this.monthPaidFor, this.method = 'cash',
    this.notes = '', this.isSynced = true, this.localId,
  });
  ...
  Map<String, dynamic> toJson() => {
    'assignment_id': assignmentId, 'amount': amount,
    'payment_date': paymentDate, 'month_paid_for': monthPaidFor,
